...
#define FUNCONF_USE_HSI           0         // Use HSI - Internal High-Frequency RC Oscillator
#define FUNCONF_USE_HSE           1         // Use HSE - External High-Frequency Oscillator
#define FUNCONF_SYSTEM_CORE_CLOCK 48000000  // Computed Clock in Hz - 24MHz x 2 = 48MHz
